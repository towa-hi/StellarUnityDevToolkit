...
namespace Stellar {
    ...
    public static partial class SignedTimeSlicedSurveyStartCollectingMessageXdr
    {
        ...
        public static SignedTimeSlicedSurveyStartCollectingMessage DecodeFromBase64(string base64)
        {
            var bytes = Convert.FromBase64String(base64);
            using (var memoryStream = new MemoryStream(bytes))
            {
                XdrReader reader = new XdrReader(memoryStream);
                return SignedTimeSlicedSurveyStartCollectingMessageXdr.Decode(reader);
            }
        }
